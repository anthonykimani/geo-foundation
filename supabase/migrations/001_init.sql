-- Supabase Migration: Brick Counter + Runners Platform
...
-- Enable realtime for live counter (optional)
ALTER PUBLICATION supabase_realtime ADD TABLE brick_transactions;
