export default {
  ...
  fields: [
    ...
    {name: 'downloadUrl', title: 'Downloadable Document', type: 'file', description: 'Optional PDF/document users can download (sponsorship deck, volunteer form, run brochure, etc.)'},
